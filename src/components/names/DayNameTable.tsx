        ...
        <div className="mb-8">
            ...
            <div className="hidden md:block overflow-x-auto">
                <table className="w-full text-sm border-collapse rounded-xl overflow-hidden border border-slate-200">
                    ...
                    <tbody>
                        {names.map((name, idx) => (
                            <tr key={name.name} className={`${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50/50'} hover:bg-amber-50/50 transition-colors border-b border-slate-100 last:border-b-0`}>
            ...
            <div className="md:hidden space-y-3">
                {names.map((name) => (
                    <div key={name.name} className="rounded-xl bg-white p-4 border border-slate-200 shadow-sm">
